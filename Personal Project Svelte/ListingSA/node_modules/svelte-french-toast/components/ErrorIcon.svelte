...
<style>
	div {
		...
		-webkit-animation: circleAnimation 0.3s cubic-bezier(0.175, 0.885, 0.32, 1.275) forwards;
	...
	div::before {
		content: '';
		-webkit-animation: firstLineAnimation 0.15s ease-out forwards;
	...
	div:before {
		-webkit-animation: secondLineAnimation 0.15s ease-out forwards;
