...
// node_modules/svelte-toastify/dist/index.js
var require_dist = __commonJS({
  "node_modules/svelte-toastify/dist/index.js"(exports, module) {
    (function(global, factory) {
      typeof exports === "object" && typeof module !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : (global = global || self, factory(global.Toastify = {}));
      ...
      class Toast {
        ...
        validateOptions(options) {
          if (this.config.preventDuplicate && options.toastId) {
            return this.idMap[options.toastId] === void 0;
          }
          return true;
        }
        mergeOptions(type, options) {
          options = Object.assign(Object.assign({}, options), { autoClose: options.autoClose !== void 0 ? options.autoClose : this.config.autoClose, toastId: options.toastId ? options.toastId : generateToastId(), closeButton: options.closeButton !== void 0 ? options.closeButton : this.config.closeButton, bodyClassName: options.bodyClassName !== void 0 ? options.bodyClassName : this.config.bodyClassName });
      ...
      function create_if_block(ctx) {
        ...
        return {
          ...
          p(ctx2, dirty) {
            if (switch_value !== (switch_value = /*closeButton*/
            ctx2[0])) {
              if (switch_instance) {
                group_outros();
      ...
      function instance($$self, $$props, $$invalidate) {
        ...
        $$self.$set = ($$props2) => {
          ...
          if ("closeButton" in $$props2)
            $$invalidate(0, closeButton = $$props2.closeButton);
          if ("type" in $$props2)
      ...
      class CloseButton extends SvelteComponent {
        constructor(options) {
          super();
          if (!document.getElementById("svelte-1udl97b-style"))
            add_css();
      ...
      function create_if_block_2(ctx) {
        ...
        return {
          c() {
            div = element("div");
            img2 = element("img");
            if (img2.src !== (img_src_value = /*icon*/
            ctx[5]))
              attr(img2, "src", img_src_value);
            attr(img2, "alt", "icon");
            attr(img2, "class", "svelte-1w9tgj9");
          ...
          p(ctx2, dirty) {
            if (dirty & /*icon*/
            32 && img2.src !== (img_src_value = /*icon*/
            ctx2[5])) {
              attr(img2, "src", img_src_value);
            }
          },
      ...
      function create_if_block$1(ctx) {
        ...
        return {
          ...
          p(ctx2, dirty) {
            ...
            if (dirty & /*onClose*/
            8)
              closebutton_changes.onClose = /*onClose*/
              ctx2[3];
            if (dirty & /*closeButton*/
            16)
              closebutton_changes.closeButton = /*closeButton*/
              ctx2[4];
            if (dirty & /*type*/
            4)
              closebutton_changes.type = /*type*/
              ctx2[2];
        ...
        return {
          ...
          p(ctx2, [dirty]) {
            ...
            if (default_slot) {
              ...
              16384) {
                default_slot.p(get_slot_context(
                  default_slot_template,
                  ctx2,
                  /*$$scope*/
                  ctx2[14],
            ...
            if (!current || dirty & /*computedClassName*/
      ...
      function instance$1($$self, $$props, $$invalidate) {
        ...
        let { className } = $$props;
        let { position } = $$props;
        const getClassNames = (type2) => {
          if (position === "top-right" || position === "bottom-right") {
            return `toast-item animate-right toast-item--${type2}`;
          }
          return `toast-item animate-left toast-item--${type2}`;
        };
        const dispatch = createEventDispatcher();
        let deleteTimeOut;
        onMount(() => {
        ...
        $$self.$set = ($$props2) => {
          ...
          if ("autoClose" in $$props2)
            $$invalidate(7, autoClose = $$props2.autoClose);
          if ("closeButton" in $$props2)
      ...
      class ToastItem extends SvelteComponent {
        constructor(options) {
          super();
          if (!document.getElementById("svelte-1w9tgj9-style"))
            add_css$1();
      ...
      function create_else_block$1(ctx) {
        ...
        return {
          ...
          p(ctx2, dirty) {
            if (switch_value !== (switch_value = /*toastr*/
            ctx2[6].body)) {
              if (switch_instance) {
                group_outros();
                const old_component = switch_instance;
      ...
      function create_if_block$2(ctx) {
        ...
        return {
          ...
          p(ctx2, dirty) {
            if (dirty & /*toastStoreValue*/
            1 && t_value !== (t_value = /*toastr*/
            ctx2[6].body + ""))
              set_data(t, t_value);
          },
          i: noop,
        ...
        return {
          ...
          p(ctx2, dirty) {
            if (default_slot) {
              ...
              if (default_slot_or_fallback && default_slot_or_fallback.p && dirty & /*toastStoreValue*/
              1) {
      ...
      function create_each_block(ctx) {
        ...
        return {
          ...
          p(ctx2, dirty) {
            ...
            if (dirty & /*toastStoreValue*/
            1)
              toastitem_changes.id = /*toastr*/
              ctx2[6].toastId;
            if (dirty & /*toastStoreValue*/
            1)
              toastitem_changes.title = /*toastr*/
              ctx2[6].title;
            if (dirty & /*toastStoreValue*/
            1)
              toastitem_changes.type = /*toastr*/
              ctx2[6].type;
            if (dirty & /*toastStoreValue*/
            1)
              toastitem_changes.icon = /*toastr*/
              ctx2[6].icon;
            if (dirty & /*toastStoreValue*/
            1)
              toastitem_changes.onClose = /*toastr*/
              ctx2[6].onClose;
            if (dirty & /*toastStoreValue*/
            1)
              toastitem_changes.autoClose = /*toastr*/
              ctx2[6].autoClose;
            if (dirty & /*toastStoreValue*/
            1)
              toastitem_changes.closeButton = /*toastr*/
              ctx2[6].closeButton;
            if (dirty & /*toastStoreValue*/
            1)
              toastitem_changes.className = /*toastr*/
              ctx2[6].bodyClassName;
            if (dirty & /*$$scope, toastStoreValue*/
            33) {
              toastitem_changes.$$scope = { dirty, ctx: ctx2 };
            }
      ...
      function create_fragment$2(ctx) {
        ...
        return {
          ...
          p(ctx2, [dirty]) {
            if (dirty & /*toastStoreValue, toast, onDelete, $$scope*/
            37) {
              each_value = /*toastStoreValue*/
              ctx2[0];
              let i;
      ...
      class Toast$1 extends SvelteComponent {
        constructor(options) {
          super();
          if (!document.getElementById("svelte-1h1qykv-style"))
            add_css$2();
          init(this, options, instance$2, create_fragment$2, safe_not_equal, {});
        }
      }
      exports2.ToastContainer = Toast$1;
...
//# sourceMappingURL=svelte-toastify.js.map
